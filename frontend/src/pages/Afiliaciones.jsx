...
export default function Afiliaciones() {
  ...
  }, [personaSeleccionada, showFormularioModal, formularioSaving]);
  ...
  return (
    <div className="afi-page">
      ...
      <FormularioCargaModal
        ...
        proyectoOptions={formProyectoOptions}
        formularioOptions={formFormularioOptions}
        onFormularioChange={handleFormularioPendienteChange}
